...
public class StatefulWLAPOCEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(StatefulWLAPOCEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/StatefulWLAPOC/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/StatefulWLAPOC/InitOutcome.xml").getDocumentElement();
